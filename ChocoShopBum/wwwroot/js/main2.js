...
function orderItem(noCategory, indeks){
  ...
  if(noCategory==1){
    orderItems=`<div id="item-order-box">
                  <div class="item_details_img"><img class="item-img" src="/torte/torta${indeks}.jpg" alt="Item"></div>
  ...
  if(noCategory==2){
    orderItems=`<div id="item-order-box">
                  <div class="item_details_img"><img class="item-img" src="/kolaci/kolaci${indeks}.jpg" alt="Item"></div>
  ...
  if(noCategory==3){
    orderItems=`<div id="item-order-box">
                  <div class="item_details_img"><img class="item-img" src="/praline/praline${indeks}.jpg" alt="Item"></div>
  ...
  if(noCategory==4){
    orderItems=`<div id="item-order-box">
                  <div class="item_details_img"><img class="item-img" src="/specijalna_ponuda/specijalna${indeks}.jpg" alt="Item"></div>
...
function closeWindow(){
  document.getElementById("choose_item_window").style.display="none";
}
class Product{
...
function orderingItems(){
  ...
  console.log(glavnaKorpa.niz);
  console.log(glavnaKorpa.brojItema);
  console.log(glavnaKorpa.ukupnaCijena);
}
...
function closeCart(){
  document.getElementById("shopping_cart_window").style.display="none";
}